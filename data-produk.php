            ...
            <div class="box">
                ...
                <table border="1" cellspacing="0" class="table">
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        $produk = mysqli_query($conn, "SELECT * FROM tb_product LEFT JOIN tbl_category USING (category_id) ORDER BY product_id DESC");
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="hapus.php?idp=<?php echo $row['product_id'] ?>" onclick="return confirm('Apakah produk ingin dihapus ?')">Hapus</a>
                                    </td>
                                </tr>
                            <?php }
                        } else { ?>
